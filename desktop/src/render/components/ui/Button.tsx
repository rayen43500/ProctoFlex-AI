...
export default function Button({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-500 border border-gray-300 shadow-sm hover:shadow-md',
    success: 'bg-success text-white hover:bg-success-600 focus:ring-success-500 shadow-md hover:shadow-lg',
    warning: 'bg-warning text-white hover:bg-warning-600 focus:ring-warning-500 shadow-md hover:shadow-lg',
    danger: 'bg-danger text-white hover:bg-danger-600 focus:ring-danger-500 shadow-md hover:shadow-lg',
  ...
  return (
    ...
    >
      {loading && (
        <svg className={`animate-spin ${iconPosition === 'left' ? 'mr-2' : 'ml-2'} ${iconSize}`} fill="none" viewBox="0 0 24 24">
